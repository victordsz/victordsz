...
### **Back-end & Dados (Em Formação Técnica)**
...
* **Agile:** Experiência com **Scrum** e **Kanban**.
* **Versionamento:** Domínio de **Git** e fluxo de trabalho **GitFlow**.
* **Product Ownership:** Visão estratégica de produto aplicada ao desenvolvimento técnico.
...
> *"O aprendizado é um processo contínuo; a busca pela maestria é o que nos move."* 🛡️🚀
